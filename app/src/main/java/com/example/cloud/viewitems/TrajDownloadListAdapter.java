 ...
 * @see com.example.cloud.fragments.FilesFragment on how the data is generated
 * @see com.example.cloud.ServerCommunications on where the response items are received.
 *
...
public class TrajDownloadListAdapter extends RecyclerView.Adapter<TrajDownloadViewHolder>{
     ...
     *
     * @see com.example.cloud.Traj protobuf objects exchanged with the server.
     */
     ...
     * {@inheritDoc}
     *
     * @see com.example.cloud.R.layout#item_trajectorycard_view xml layout file
     */
    @NonNull
    @Override
     ...
     *
     * @see com.example.cloud.fragments.FilesFragment generating the data from server response.
     * @see com.example.cloud.R.layout#item_sensorinfo_card_view xml layout file.
     */
    @Override
