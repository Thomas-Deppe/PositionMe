...
import com.example.cloud.ServerCommunications;
import com.example.cloud.sensors.Observer;
import com.example.cloud.viewitems.TrajDownloadListAdapter;
 ...
 * @see com.example.cloud.Traj the data structure sent and received.
 * @see com.example.cloud.ServerCommunications the class handling communication with the server.
 *
...
public class FilesFragment extends Fragment implements Observer {
     ...
     *
     * @see com.example.cloud.viewitems.TrajDownloadViewHolder the View Holder for the list.
     * @see TrajDownloadListAdapter the list adapter for displaying the recycler view.
     * @see com.example.cloud.R.layout#item_trajectorycard_view the elements in the list.
     */
    @Override
