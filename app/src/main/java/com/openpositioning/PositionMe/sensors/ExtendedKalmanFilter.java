...
public class ExtendedKalmanFilter {
    ...
    private void updateQk (double averageStepLength, double theta_k){
        Log.d("EKF:", "update Qk... average Step = "+averageStepLength+ " theta_k = "+theta_k);
        double step_error = stepPercentageError * averageStepLength + stepMisdirection;
    ...
    public void predict(double theta_k, double step_k, double averageStepLength) {
        ekfHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                updateQk(averageStepLength, adaptedHeading);
    ...
    public void onObservationUpdate(double observeEast, double observeNorth, double pdrEast, double pdrNorth, double altitude){
        ekfHandler.post(new Runnable() {
            @Override
            public void run() {
